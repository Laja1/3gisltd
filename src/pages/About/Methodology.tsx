  ...
  return (
    ...
    <div className="w-[330px] md:w-[600px] lg:w-[1000px]"><Accordion type="single" collapsible className="w-full">
      <AccordionItem value="item-1">
        <AccordionTrigger className="raleway">Clarify</AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-3">
       ...
       <AccordionItem value="item-4">
        <AccordionTrigger className="raleway">Implement</AccordionTrigger>
        <AccordionContent>
       ...
       <AccordionItem value="item-5">
        <AccordionTrigger className="raleway">Enhance</AccordionTrigger>
        <AccordionContent>
